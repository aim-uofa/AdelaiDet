...
The configs are made for 8-GPU training. To train on another number of GPUs, change the `num-gpus`. We set `OMP_NUM_THREADS=1` by default, which achieves best speed on our machines, please change it as needed.
